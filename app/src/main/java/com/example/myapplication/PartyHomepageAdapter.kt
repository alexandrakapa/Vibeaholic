...
class PartyHomepageAdapter(val posts: ArrayList<String>, val activity: MainActivity) :  RecyclerView.Adapter<PartyHomepageAdapter.Viewholder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PartyHomepageAdapter.Viewholder {

        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.party_homepage_create_song_view, parent, false)
